...
if not exist temp\adVirCDatabases.zip ( call :error %lang_wgetError% & exit /b )
...
if not exist files\databases\original\license.txt ( call :error %lang_unZipError% & exit /b )
