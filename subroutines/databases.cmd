...
if exist %dataDir%\reports\firefoxUserProfile.rpt del /q %dataDir%\reports\firefoxUserProfile.rpt
if exist "%appData%\Mozilla\Firefox\Profiles" for /f "delims=" %%i in ('dir "%appData%\Mozilla\Firefox\Profiles" /a:d /b') do (
  if "%setting_reports_collect%" == "true" echo.%%i>>%dataDir%\reports\firefoxUserProfile.rpt
